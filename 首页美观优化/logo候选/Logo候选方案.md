...
1. 根据入选方向重新绘制确定性 SVG，不直接描摹生成图中的文字。
2. 固定 24px、32px、导航横版和纯图形四种尺寸。
3. 输出深色背景反白、浅色背景深色和单色版本。
4. 替换顶部导航标识、favicon、站点元数据图片，并做 360–1440px 回归。
5. 检查与已知 AI、媒体和金融品牌的近似风险。
