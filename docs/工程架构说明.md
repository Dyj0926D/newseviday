...
当前仓库已经实现版本化 Chunk、Python hashing dense 基线、article fallback、上下文预算、Worker SSE 引用回答、证据阈值拒答、匿名 Trace 和 Eval Runner。BGE-M3 适配器与 Vectorize NDJSON 已提供；Cloudflare 外部索引创建、binding 和生产向量检索仍挂起。
...
- Chunking、hashing dense、article fallback、Vectorize 导出和 30 题 Eval Runner；
