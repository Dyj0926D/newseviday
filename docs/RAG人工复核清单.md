...
2026-08-24 已完成 v2 的 A–C 批次人工复核：q01–q09 通过，q10–q12 暴露三项缺陷，q13–q24 拒答识别 12/12 正确。v3 已完成工程修复并生成新复核包，q10–q12 待人工重新确认；回答引用复核尚未开始，因此在线 RAG 继续关闭。
...
| 批次 | 题目 | 要确认的内容 | 通过标准 |
| --- | --- | --- | --- |
| A | q01–q10 | 单一事实、Agent 工程、AI 安全与 RAG 问题的期望文章是否正确 | q01–q09 已通过；q10 已修订证据口径，待 v3 复核 |
| B | q11–q12 | 多来源归纳是否覆盖了全部必要文章 | 已实现双主体拆分和两侧来源保留，待 v3 复核 |
...
当前状态：v2 的 A–C 已完成人工填写；v3 工程回归达到 Recall@5 1.0、Hit@5 1.0，q10–q12 待人工重新签字。D 尚未开始，生产 Gate 保持关闭。
