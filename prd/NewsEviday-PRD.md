...
| 文档版本 | v1.2.5 |
| 文档状态 | P3 静态产品已完成；8 个公开页面、页面流转与六档响应式回归通过 |
| 更新日期 | 2026-08-02 |
...
- [x] 页面顶部不展示虚构指标和虚构客户。
- [x] 产品介绍、技术架构、RAG 和评测均有独立内容区。
- [x] 用户能区分目标指标与实际结果。
- [x] 页面明确说明 Python、Embedding 和生成模型的能力边界。
- [x] 页面明确标注 newnews 为参考案例，且不声称复制其代码或结果。
- [x] 页面在 PC 和手机端均能完成主要浏览。
- [x] 首屏核心价值和主 CTA 在初始视口内。
- [x] 页面提供信息流、Eval、GitHub 和 PRD 入口。
