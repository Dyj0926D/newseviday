...
| 文档版本 | v1.2.4 |
| 文档状态 | 页面、流转和视觉规范已固定；P2.5 技术地基完成，P3 首页实施中 |
| 更新日期 | 2026-08-02 |
...
页面信息来源：产品文案和架构来自版本化仓库文档；界面预览来自实际产品截图；Eval 结果来自最新 `EvalRun`；状态来自 `/api/status`；GitHub、PRD 和实施进度链接来自站点配置。
...
- [ ] 从画像页返回首页时切换到 `/?view=recommended`，并展示推荐原因。
- [ ] 不支持账号同步，不制造已登录假象。
